...
export default function Home() {
  return (
      ...
      <section
        id="home"
        className="relative w-full h-screen flex flex-col justify-end pb-16 sm:pb-20 md:pb-24"
      >
        {/* Background Video */}
        ...
        {/* HERO CONTENT */}
        <div className="relative z-10 w-full text-center px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-foreground/60">
                ...
                <li>
                  <Link to="/contact"
                  className="hover:text-foreground"> Contact</Link>
                </li>
              </ul>
            </div>
